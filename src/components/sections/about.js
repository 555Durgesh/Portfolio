...
const About = () => {
  ...
  const skills = ['Kotlin', 'C++', 'Android', 'PHP', 'JavaScript', 'WordPress'];
    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! I'm Durgesh Mishra, passionate about crafting digital solutions. I started programming during my freshman year at { ''}<a href="https://www.swarrnim.edu.in/">Swarrnim Startup & Innovation University, Gandhinagar</a>,{' '}
              pursuing a Bachelor's in Computer Application, graduating in 2024 with an 8.37% aggregate.
            ...
            <p>
            Today, my primary focus is on crafting accessible, inclusive products and digital experiences. Let's collaborate to create exceptional mobile experiences together!
            </p>
